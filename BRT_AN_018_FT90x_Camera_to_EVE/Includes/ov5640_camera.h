 ...
 */
//@{
#define OV5640_LINE_COUNT_MJPEG_QVGA (((16 * 1024)/CAMERA_PREFERRED_LINE_LENGTH) + 1)
#define OV5640_LINE_COUNT_MJPEG_VGA (((32 * 1024)/CAMERA_PREFERRED_LINE_LENGTH) + 1)
#define OV5640_LINE_COUNT_MJPEG_SVGA (((48 * 1024)/CAMERA_PREFERRED_LINE_LENGTH) + 1)
#define OV5640_LINE_COUNT_MJPEG_XGA (((64 * 1024)/CAMERA_PREFERRED_LINE_LENGTH) + 1)
#define OV5640_LINE_COUNT_MJPEG_SXGA (((128 * 1024)/CAMERA_PREFERRED_LINE_LENGTH) + 1)
 ...
 */
int8_t ov5640_supports(int resolution, int frame_rate, int format);
...
/**
 ...
 @details Configures the OV5640 module to a resolution, frame rate and
   output format.
 */
int8_t ov5640_set(int resolution, int frame_rate, int format);
